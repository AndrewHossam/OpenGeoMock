package com.andrewhossam.opengeomock.util.location
...
class FineLocationManager(
    context: Context,
    locationUpdateCallback: (Location) -> Unit,
) {
    private val locationManager = context.getSystemService<LocationManager>()!!
    private val mainExecutor = ContextCompat.getMainExecutor(context)
    private val currentLocationConsumer =
        Consumer<Location?> {
            if (it != null) {
